 ...
 * @property {number} hp          laser hits per tile at mk1 (rises with depth; upgrade the
 *                                laser to keep digging feeling like exploration, not labour)
...
export const STRATA = [
  {
    id: 'anthropocene', era: 'Anthropocene', mya: [0, 0.1], depth: [0, 48], hp: 1, realDepth: [0, 3],
    colors: { base: '#B5AC9C', alt: '#A99F8F', band: '#9A9080', speckle: '#7E7466' },
    texture: { banding: 0.3, speckle: 0.8 },
  },
  {
    id: 'quaternary', era: 'Quaternary', mya: [0.1, 2.6], depth: [48, 160], hp: 1, realDepth: [3, 50],
    colors: { base: '#D9C49A', alt: '#CFB88A', band: '#C2A97A', speckle: '#A98F5F' },
    texture: { banding: 0.2, speckle: 0.7 },
  },
  {
    id: 'paleogene', era: 'Paleogene', mya: [2.6, 66], depth: [160, 320], hp: 2, realDepth: [50, 300],
    colors: { base: '#E0B586', alt: '#D6A876', band: '#C99966', speckle: '#B0804E' },
    texture: { banding: 0.6, speckle: 0.4 },
  },
  {
    id: 'cretaceous', era: 'Cretaceous', mya: [66, 145], depth: [320, 560], hp: 2, realDepth: [300, 800],
    colors: { base: '#E2DCC0', alt: '#D8D1B1', band: '#CAC29F', speckle: '#B1A882' },
    texture: { banding: 0.5, speckle: 0.3 },
  },
  {
    id: 'jurassic', era: 'Jurassic', mya: [145, 201], depth: [560, 800], hp: 3, realDepth: [800, 1500],
    colors: { base: '#AFC49E', alt: '#A1B88E', band: '#91A97C', speckle: '#758D60' },
    texture: { banding: 0.7, speckle: 0.3 },
  },
  {
    id: 'triassic', era: 'Triassic', mya: [201, 252], depth: [800, 1000], hp: 3, realDepth: [1500, 2200],
    colors: { base: '#D49C87', alt: '#CA8D76', band: '#BC7C64', speckle: '#A1614A' },
    texture: { banding: 0.8, speckle: 0.4 },
  },
  {
    id: 'carboniferous', era: 'Carboniferous–Permian', mya: [252, 359], depth: [1000, 1240], hp: 4, realDepth: [2200, 3200],
    colors: { base: '#A29AB2', alt: '#948BA6', band: '#827A96', speckle: '#68607D' },
    texture: { banding: 0.9, speckle: 0.5 },
  },
  {
    id: 'devonian', era: 'Devonian–Silurian', mya: [359, 444], depth: [1240, 1480], hp: 5, realDepth: [3200, 4200],
    colors: { base: '#96B0C5', alt: '#86A2BA', band: '#7391AB', speckle: '#59788F' },
    texture: { banding: 0.6, speckle: 0.5 },
  },
  {
    id: 'cambrian', era: 'Cambrian–Ordovician', mya: [444, 539], depth: [1480, 1740], hp: 6, realDepth: [4200, 5500],
    colors: { base: '#A3A1B6', alt: '#9593AA', band: '#84829A', speckle: '#6B6980' },
    texture: { banding: 0.4, speckle: 0.6 },
  },
  {
    id: 'precambrian', era: 'Precambrian', mya: [539, 4600], depth: [1740, Infinity], hp: 8, realDepth: [5500, 8000],
...
export function realDepthAt(depth) {
  ...
  const to = Number.isFinite(s.depth[1]) ? s.depth[1] : from + 200;
